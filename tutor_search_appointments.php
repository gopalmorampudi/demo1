...
<td>
	<?php
	echo $formTime="<b>From Time:- </b> " . (($row['from_hour']<9)?'0'.$row['from_hour']:$row['from_hour']).":".(($row['from_min']<9)?'0'.$row['from_min']:$row['from_min']) ;
	echo "<br>";
	echo $toTime="<b>From Time:- </b> " . (($row['to_hour']<9)?'0'.$row['to_hour']:$row['to_hour']).":".(($row['to_min']<9)?'0'.$row['to_min']:$row['to_min']) ;
